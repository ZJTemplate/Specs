...
Pod::Spec.new do |s|
  s.name             = 'ZygoteApmNetReporter'
  s.version          = '0.1.11'
  s.summary          = 'A short description of ZygoteApmNetReporter.'
...
TODO: Add long description of the pod here.
  ...
  s.source = { :http => "https://p-template-hk.oss-cn-hongkong.aliyuncs.com/ios_sdk/ZygoteApmNetReporter/0.1.11/ZygoteApmNetReporter_13.zip" }
